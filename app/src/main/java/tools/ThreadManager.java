...
public class ThreadManager {
        ...
        if(threadPool == null) {
            ...
            synchronized(ThreadManager.class) {
                if(threadPool == null) {
                    ...
                    threadPool = new ThreadPool(corePoolSize, maximumPoolSize,
                            keepAliveTime);
                }
            }
        }
    ...
    public static class ThreadPool {
        ...
        private long keepAliveTime; // 限制线程的的最大存活时间
        ...
        public void execute(Runnable runnable) {
            ...
            if(executor == null) {
                ...
                executor = new ThreadPoolExecutor(corePoolSize, maximumPoolSize,
                        ...
                        new LinkedBlockingQueue<Runnable>(128),// 线程队列
